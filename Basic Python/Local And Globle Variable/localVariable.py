...
'''
local variable use only inside the funtion 
Globle variable use both inside or outside using this variable
'''

# def addi ():
#     # a="Aditya"      local variable
#     print(a)
# addi()
