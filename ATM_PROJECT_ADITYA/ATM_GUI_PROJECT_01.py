...
def admin_info_window():
    ...
    admin_info_window.geometry('800x675')

   
    login_image_path = 'A:/Python With DS/TKinter/Image/ac_01.png'
    login_image = Image.open(login_image_path)
...
def createnewaccount():
    global name_entry,city_entry,account_type_combobox,balance_entry
    create_ac_window = tk.Toplevel(a)
    create_ac_window.title('CREATE NEW ACCOUNT')
    create_ac_window.geometry('800x480')

    
    craete_image_path = 'A:/Python With DS/TKinter/Image/newAccountCreateImg.png'
    ...
    account_type_combobox = ttk.Combobox(create_ac_window, values=['Current Account', 'Savings Account'], font=('Helvetica', 12))
    account_type_combobox.place(x=520, y=250, width=250)
...
def createAccount():
    ...
    name = name_entry.get()
    city = city_entry.get()
    acType = account_type_combobox.current()
...
def addnewadmin():
    ...
    addnewadmin_image_path ='A:/Python With DS/TKinter/Image/addnewadmin.png'
...
def user_panel():
    ...
    user_panel_image_path = 'A:/Python With DS/TKinter/Image/user_panel_logo2.png'
...
def diposit():
    ...
    deposit_image_path ='A:/Python With DS/TKinter/Image/diposit.png'
...
def withdrawal():
    ...
    withdrawal_image_path ='A:/Python With DS/TKinter/Image/withdrawal.png'
...
def updateinfo():
    ...
    update_image_path = 'A:/Python With DS/TKinter/Image/update.png'
...
def updatename():
    ...
    updatename_window_image_path ='A:/Python With DS/TKinter/Image/UPPDATENAME.png'
...
def updateactype():
    global account_type_combobox_update
    ...
    account_type_combobox_update = ttk.Combobox(updateactype_window, values=['Current Account', 'Savings Account'], font=('Helvetica', 12))
    account_type_combobox_update.place(x=250, y=350, width=200)
...
def updateacTypeGUI():
    global account_entry,pin_entry,account_type_combobox_update
    enterd_user_account = account_entry.get()
    enterd_user_pin = pin_entry.get()
    entered_acType = account_type_combobox_update.get()
...
def changepin():
    ...
    changepin_image_path ='A:/Python With DS/TKinter/Image/changepin.png'
